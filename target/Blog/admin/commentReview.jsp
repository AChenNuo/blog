...
<head>
    ...
    <script type="text/javascript">
        ...
        //获取博客的标题,row代表这条数据，当前这行，val表示字段与field对应
        ...
        function commentReview(state) {
            ...
            if (selectedRows.length == 0){
                $.messager.alert("系统提示","请选择需要审核的评论");
                return;
            }
            var strIds= [];
...
<table id="dg" class="easyui-datagrid" title="评论审核管理" pagination="true" fitcolumns="true" fit="true"
